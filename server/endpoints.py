...
groups in any client that sorts by name (e.g. Claude Desktop):
  ...
  zoom_message_* — individual messages, threads, files, pinned, bookmarks, mentions
  zoom_search_*  — AI Companion search/ask + manual fan-out
"""
...
ENDPOINTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": (
            ...
            "specific citation returned by zoom_search_ai or zoom_search_ask."
        ),
        "handler": "get_message",
        "body": {
